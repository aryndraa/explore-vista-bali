            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 mb-10">
                <div>
                    ...
                    <ul class="mt-8 space-y-1 text-sm text-gray-700 dark:text-gray-200">
                        <li><b>Address :</b> Jln. Your Street Name, Denpasar Barat, Bali, Indonesia.</li>
                    </ul>

                    <ul class="mt-8 flex gap-5 [&_li]:flex [&_li]:items-center [&_li]:justify-center">
                        <li>
                            <a href="#" rel="noreferrer" target="_blank"
                                class="text-cst-yellow-400 transition hover:opacity-75">
                        ...
                        <li>
                            <a href="#" rel="noreferrer" target="_blank"
                                ...
                                <svg class="size-5" viewBox="0 0 22 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M16.8912 0.562012H20.175L13.0027 8.75758L21.4401 19.9114H14.8353L9.65843 13.1484L3.74199 19.9114H0.453528L8.1235 11.1437L0.0349121 0.562012H6.80719L11.4817 6.74357L16.8912 0.562012ZM15.7377 17.9485H17.5563L5.81646 2.42253H3.86292L15.7377 17.9485Z"
                                        fill="currentColor" />
                                </svg>
                            </a>
                        </li>
