<div class="-space-y-5 group overflow-hidden {{ $i > 2 ? 'hidden md:inline-block' : '' }}">
    <div class="relative -z-10">
        <span
            ...
            Tour</span>
        <img class="-z-10 w-full min-h-48 object-cover object-center transition group-hover:scale-105"
    ...
    <div class="bg-gray-200 p-5 rounded-t-xl z-10">
        ...
        <div class="flex flex-wrap justify-start gap-4 sm:gap-4 font-inter [&_p]:font-semibold mb-4">
