...
@section('content')
    ...
    <section class="bg-gray-200/80">
        <div class="container mx-auto py-16 px-8 [&_h4]:font-roboto [&_h4]:font-medium [&_h4]:text-xl">
            ...
            <p class="font-inter text-justify leading-normal mb-6">
                Lorem ipsum dolor sit amet consectetur. Vulputate quis sed pellentesque non metus nullam dapibus. Elit diam
                vel porttitor bibendum condimentum vulputate sed. Ultrices molestie vel interdum et turpis. Blandit elit non
                aliquam enim in diam faucibus. Praesent nulla turpis nunc pulvinar dui fusce cursus in. Aliquam feugiat
                suspendisse tempor urna leo ipsum arcu. Sodales vel erat vitae dictum morbi pretium varius imperdiet ante.
            </p>
            ...
            <div class="mt-8 mb-8 flex w-full flex-wrap gap-4">
                <div class="bg-cst-green-400 flex flex-1 items-center gap-4 px-5 py-4 rounded-md w-fit">
                    ...
                    <div class="font-inter">
                        ...
                        <h5 class="text-white text-2xl font-medium">09.00 <b>AM</b></h5>
                    </div>
                </div>
                ...
                <div class="bg-cst-green-400 flex flex-1 items-center gap-4 px-5 py-4 rounded-md w-fit">
                    ...
                    <div class="font-inter">
                        ...
                        <h5 class="text-white text-2xl font-normal"><b>AUD</b> $50</h5>
                    </div>
                </div>
            </div>

            {{-- Book Form --}}
            <form action="" class="bg-white p-4 font-inter">
                @csrf
                <h4 class="font-roboto font-semibold text-4xl text-center mb-5">Book Form</h4>

                <div class="flex flex-col gap-3 [&>div]:p-3">
