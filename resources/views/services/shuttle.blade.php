...
@section('content')
    ...
    <section class="container mx-auto flex flex-col justify-center items-center w-full min-h-screen pt-24 pb-16 px-8">
        ...
        <div class="text-center mb-14">
            <p class="font-inter text-gray-300 text-xl mb-2">Shuttle Type</p>
            <h2 class="font-roboto font-semibold text-white text-4xl">
                Choose your
        ...
        <div class="flex flex-col gap-5 md:flex-row [&>div]:hover:-translate-y-2 [&>div]:transition">
            ...
            {{-- Harbour Card --}}
            <div class="flex-1 flex flex-col -space-y-4 overflow-hidden max-w-sm">
